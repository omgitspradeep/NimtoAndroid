...
public class CustomizedGalleryAdapter extends BaseAdapter {
    ...
    private final List<com.pk.nimto.models.marriagedata.Gallery> imagesList;

    public CustomizedGalleryAdapter(Context c, List<com.pk.nimto.models.marriagedata.Gallery> images) {
        context = c;
