...
public class TempParents {
    ...
    public TempParents(String bride_father_fullname, String bride_mother_fullname, String groom_father_fullname, String groom_mother_fullname) {
