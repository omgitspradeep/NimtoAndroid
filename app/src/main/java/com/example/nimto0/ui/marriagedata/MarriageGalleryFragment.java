...
import com.example.nimto0.adapters.CustomizedGalleryAdapter;
import com.example.nimto0.interfaces.MainInterface;
import com.example.nimto0.interfaces.commonListener;
import com.example.nimto0.models.SendData.TempGallery;
...
public class MarriageGalleryFragment extends Fragment implements Validator.ValidationListener, MainInterface.onGalleryImageUpdate, MainInterface.onGalleryImageCreate{
    ...
    List<com.example.nimto0.models.marriagedata.Gallery> galleryList;
    LinearLayout imageStage;
    FloatingActionButton createImage;
    com.example.nimto0.models.marriagedata.Gallery selectedGalleryImageObject;
    ...
    private void inflateData(List<com.example.nimto0.models.marriagedata.Gallery> galleries) {
    ...
    @Override
    public void isImageCreated(boolean isSuccessful, com.example.nimto0.models.marriagedata.Gallery createdImage) {
    ...
    @Override
    public void isImageUpdated(boolean isSuccessful, com.example.nimto0.models.marriagedata.Gallery updatedImage, int imageID, boolean deleteOrUpdate) {
